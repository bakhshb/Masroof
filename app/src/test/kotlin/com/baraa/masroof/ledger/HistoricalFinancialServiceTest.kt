...
class HistoricalFinancialServiceTest {
    ...
    private fun account(id: Long = 1, nature: AccountNature = AccountNature.ASSET, amount: String = "100") = FinancialAccount(id, "حساب", null, AccountType.BANK_ACCOUNT, nature, null, emptyList(), Currency.SAR, BigDecimal(amount), opening.atStartOfDay(zone).toInstant().toEpochMilli(), true, nature == AccountNature.ASSET, true, null, true, null)
