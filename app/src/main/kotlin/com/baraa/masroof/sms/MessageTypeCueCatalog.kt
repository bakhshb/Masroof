...
object MessageTypeCueCatalog {
    ...
    private val RULES: List<Rule> = listOf(
        ...
        Rule(
            listOf(
                "تفعيل خدمة", "تفعيل الخدمة", "تفعيل خدمه", "تفعيل الخدمه",
                "إيقاف خدمة", "إيقاف الخدمة", "ايقاف خدمه", "ايقاف الخدمه",
                "خدمة الشراء الآمن", "خدمه الشراء الامن", "الشراء الآمن عبر", "الشراء الامن عبر",
                "بعض خدماتنا ستكون غير متاحة", "بعض خدماتنا ستكون غير متاحه",
                "خدماتنا ستكون غير متاحة", "خدماتنا ستكون غير متاحه",
                "صيانة دورية", "صيانة", "صيانه",
                "secure purchase service", "service activation", "service deactivation",
                "scheduled maintenance", "service maintenance",
            ),
            "إشعار خدمة", TransactionType.NON_FINANCIAL, MoneyFlowDirection.NONE, "TYPE:NON_FINANCIAL",
        ),
        Rule(
            listOf(
